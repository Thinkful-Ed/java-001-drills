...
Using this program as a starting point, write a program that prompts the user for a total, a tax rate in percent and a service charge in percent. Calculate the amount of tax and the amount of service charge owed and print those values to the screen. Finally print a total amount on screen.