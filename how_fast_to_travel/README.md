...
Using this program as a starting point, write a program that prompts the use for integer values for distance to a destination and the time required to get there. Then calculate and print the average speed required as a floating point value.